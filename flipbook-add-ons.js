...
const LeadGen = {
    ...
    renderModal: function() {
        ...
        // 🔥 লক স্ক্রিনের নিচে অ্যাডসেন্স ইনজেক্ট করার কোড
        if (typeof AdSenseManager !== 'undefined') {
            AdSenseManager.injectLeadGenAd();
        }		
    },
...
/**
 * FlipBook Pro - Google AdSense Integration Manager
 * Developed for premium ad placement control (Per-Page Support)
 */
const AdSenseManager = {
    ...
    config: {
        ...
        placements: {
            aboveBook: {
                ...
                showOnPages: [],      // ফাঁকা রাখলে সব পেজে দেখাবে। উদাহরণ: [3, 5, 7]
                excludePages: [1, 2]  // এই পেজগুলোতে দেখাবে না (যেমন: কভার পেজ ও ২ নং পেজ)
            },
            belowBook: {
                enabled: true,
            ...
            sidebar: {
                enabled: true,
                slotId: "8508694333"  // পেজ লিস্ট সাইডবারের স্লট আইডি
            },
            leadGen: {
                enabled: true,
                slotId: "8508694333"  // লক স্ক্রিন/লিড ফর্ম ওভারলের স্লট আইডি
            }
        }
    },

    // অ্যাডসেন্স স্ক্রিপ্ট ও ব্যানার লোড করা
    init: function() {
        if (!this.config.enabled || !this.config.publisherId || this.config.publisherId.includes("XXXX")) {
            return;
        }

        // অ্যাডসেন্স এসডিকে ডাইনামিকালি হেডারে যুক্ত করা
    ...
    // HTML-এ অ্যাড ট্যাগ ইনজেক্ট করা
    ...
    // পেজ ফ্লিপ ট্র্যাকিং এবং শো/হাইড লজিক
    ...
    togglePlacement: function(placementKey, elementId, pageNum) {
        ...
        adEl.style.display = shouldShow ? "block" : "none";
    },

    // লিড ফর্ম ওভারলেতে বিজ্ঞাপন যুক্ত করা
