...
createAdElement: function(id, slotId) {
        const wrapper = document.createElement('div');
        wrapper.id = id;
        wrapper.className = "fbpH-adsense-wrapper";

        // স্ক্রিন সাইজ অনুযায়ী ব্যানার সাইজ নির্ধারণ
        ...
        // এখানে inline-block এবং ফিক্সড ডাইমেনশন সেট করা হয়েছে
        ins.style.cssText = `display:inline-block; width: ${adWidth}; height: ${adHeight};`;
        
        ins.setAttribute('data-ad-client', this.config.publisherId);
        ins.setAttribute('data-ad-slot', slotId);

        // অটো ও রেসপন্সিভ সাইজিং বন্ধ করা হয়েছে যাতে গুগল নিজের ইচ্ছামতো বড় বিজ্ঞাপন না দেয়
